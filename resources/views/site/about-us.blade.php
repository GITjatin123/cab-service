    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header-info">
                <h4>About Us!</h4>
                <h2>Feel your journey <br> with <span>Deep Cabs!</span></h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="section-heading mb-40">
                        ...
                        <h2>Feel the difference and Relaxation with Deep Taxi Company!</h2>
                    ...
                    <ul class="about-info">
                        ...
                        <li>
                            <h2><span>Call For Taxi</span><a href="tel:9517815169">95178-15166</a></h2>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="service-section bg-grey bd-bottom padding">
        ...
        <div class="container">
            <div class="section-heading text-center mb-40">
                ...
                <h2 class="white">Start your journey with<br>Deep Taxi Company!</h2>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-item">
                                ...
                                <div class="service-content">
                                    <h3><a href="javascript:void(0);">Regular Transport</a></h3>
                                    <p>Everything your taxi business needs is already here! Deep Cabs made for taxi service companies!</p>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                ...
                                <div class="service-content">
                                    <h3><a href="javascript:void(0);">Airport Transport</a></h3>
                                    <p>Everything your taxi business needs is already here! Deep Cabs made for taxi service companies!</p>
                                    <a class="read-more" href="javascript:void(0);">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                ...
                                <div class="service-content">
                                    <h3><a href="javascript:void(0);">Luggage Transport</a></h3>
                                    <p>Everything your taxi business needs is already here! Deep Cabs made for taxi service companies!</p>
                                    <a class="read-more" href="javascript:void(0);">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                ...
                                <div class="service-content">
                                    <h3><a href="javascript:void(0);">City Transport</a></h3>
                                    <p>Everything your taxi business needs is already here! Deep Cabs made for taxi service companies!</p>
                                    <a class="read-more" href="javascript:void(0);">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                ...
                                <div class="service-content">
                                    <h3><a href="javascript:void(0);">Business Transport</a></h3>
                                    <p>Everything your taxi business needs is already here! Deep Cabs made for taxi service companies!</p>
                                    <a class="read-more" href="javascript:void(0);">Read More</a>
                                </div>
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="section-heading mb-10">
                        ...
                        <h2>Deep Cabs Passenger Reviews...</h2>
                ...
                <div class="col-lg-6">
                    <div class="feature-wrap">
                        <div class="section-heading mb-30">
                            ...
                            <h2 class="white">Why Ride with Deep Cabs?</h2>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="javascript:void(0);">Félix Lengyel</a></h3>
                            <h4>BMW X5 2008</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="javascript:void(0);">Henry Nathan</a></h3>
                            <h4>Mercedes‑Benz</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="javascript:void(0);">Brandon Larned</a></h3>
                            <h4>Hyundai 2022</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 sm-padding">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="javascript:void(0);">Sasha Hostyn</a></h3>
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-call">
                    ...
                    <p><span>Call For Taxi</span><a href="tel:9517815169">95178-15166</a></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="post-card">
                        ...
                        <div class="post-content-wrap">
                            ...
                            <div class="post-content">
                                <h3>
                                    <a href="javascript:void(0);" class="hover">How to start initiating an startup in few days.</a>
                                </h3>
                ...
                <div class="col-lg-4 col-md-6 padding-15">
                    <div class="post-card">
                        <div class="post-thumb">
                            ...
                            <a href="javascript:void(0);" class="post-category">Startup</a>
                        </div>
                        <div class="post-content-wrap">
                            <ul class="post-meta">
                                <li><i class="las la-calendar"></i>Jan 01 2022</li>
                            ...
                            <div class="post-content">
                                <h3>
                                    <a href="javascript:void(0);">Financial experts support help you to find out.</a>
                                </h3>
                                <p>Financial experts support or help you to to find out which way you can raise your funds more...</p>
                                <a href="javascript:void(0);" class="read-more">Read More</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 padding-15">
                    <div class="post-card">
                        <div class="post-thumb">
                            ...
                            <a href="javascript:void(0);" class="post-category">Finance</a>
                        </div>
                        <div class="post-content-wrap">
                            <ul class="post-meta">
                                <li><i class="las la-calendar"></i>Jan 01 2022</li>
                            ...
                            <div class="post-content">
                                <h3>
                                    <a href="javascript:void(0);">Innovative business all over the world.</a>
                                </h3>
                                <p>Financial experts support or help you to to find out which way you can raise your funds more...</p>
                                <a href="javascript:void(0);" class="read-more">Read More</a>
                            </div>
