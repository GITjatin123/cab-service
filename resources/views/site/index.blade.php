                        ...
                        <div class="slider-content text-center pb-60">
                            <div class="slider-caption medium">
                                <div class="inner-layer">
                                    <div data-animation="fade-in-bottom" data-delay="0.3s">Travel securely with Deep Cabs!</div>
                                </div>
                            </div>
                            ...
                            <div class="slider-caption small">
                                <div class="inner-layer">
                                    <div data-animation="fade-in-bottom" data-delay="0.7s" data-duration="1s">Everything your taxi business needs is already here! <br>Deep Cabs made for taxi service companies!</div>
                                </div>
                            </div>
                            <div class="slider-btn">
                                <a href="{{route('book-taxi')}}" class="default-btn" data-animation="fade-in-bottom" data-delay="0.9s">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-item wow fade-in-bottom" data-wow-delay="200ms">
                            ...
                            <div class="service-content">
                                ...
                                <p>Everything your taxi business needs is already here! Deep Cabs made for taxi service
                                    companies!</p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="cta-content">
                    <h4>Deep Taxi Services!</h4>
                    <h2>Feel your journey with Deep Cabs!</h2>
                    <a href="{{route('book-taxi')}}" class="default-btn">Book a Taxi</a>
                </div>
            </div>
            <div class="col-lg-5">
                <ul class="check-list">
                    ...
                    <li><i class="las la-arrow-right"></i>Access Deep Cabs globally.</li>
                </ul>
            </div>
            <div class="col-lg-3">
...
<!--                        <h4><span></span>Online Booking</h4>-->
<!--                        <h2>Get the Deep Cabs Mobile app and Start Your Journey!</h2>-->
